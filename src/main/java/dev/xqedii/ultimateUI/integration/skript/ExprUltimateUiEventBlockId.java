...
public final class ExprUltimateUiEventBlockId extends SimpleExpression<String> {
   public boolean init(Expression<?>[] var1, int var2, Kleenean var3, ParseResult var4) {
      return true;
   }

   protected String[] get(Event var1) {
      return !(var1 instanceof UltimateUIBlockClickEvent var2) ? null : (String[])CollectionUtils.array(new String[]{var2.getBlockId()});
   }
   ...
   public String toString(Event var1, boolean var2) {
      return "ultimateui event block id";
   }
}
