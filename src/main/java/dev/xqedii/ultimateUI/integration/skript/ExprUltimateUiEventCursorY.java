...
public final class ExprUltimateUiEventCursorY extends SimpleExpression<Number> {
   public boolean init(Expression<?>[] var1, int var2, Kleenean var3, ParseResult var4) {
      return true;
   }

   protected Number[] get(Event var1) {
      return !(var1 instanceof UltimateUIBlockClickEvent var2) ? null : (Number[])CollectionUtils.array(new Double[]{var2.getCursorY()});
   }
   ...
   public String toString(Event var1, boolean var2) {
      return "ultimateui event cursor y";
   }
}
